...
const aInput = document.querySelector('.a') as HTMLInputElement;
...
const productBut = document.querySelector('.product') as HTMLButtonElement;
const devideBut = document.querySelector('.devide') as HTMLButtonElement;
...
plusBut.addEventListener('click', (e:{}):string => res.innerHTML = `Result: ${plus(Number(aInput.value), Number(bInput.value))}`);
minusBut.addEventListener('click', (e:{}):string => res.innerHTML = `Result: ${minus(Number(aInput.value), Number(bInput.value))}`);
productBut.addEventListener('click', (e:{}):string => res.innerHTML = `Result: ${product(Number(aInput.value), Number(bInput.value))}`);
devideBut.addEventListener('click', (e:{}):string => res.innerHTML = `Result: ${devide(Number(aInput.value), Number(bInput.value))}`);
...
loginInput.addEventListener('input', (e): void => {
...
events.sort((prevEvent: EventT, nextEvent: EventT) => new Date(prevEvent.date).getTime() - new Date(nextEvent.date).getTime())
